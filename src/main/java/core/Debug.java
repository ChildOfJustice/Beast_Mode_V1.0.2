...
import managers.MaterialManager;

import static managers.SpatialManager.makeGeometry;
...
public class Debug
{
    ...
    {
        Arrow a = new Arrow(v);
        Material mat = MaterialManager.makeMaterial(am, "Common/MatDefs/Misc/Unshaded.j3md", color);
    ...
    ///
    public static void attachWireFrameDebugGrid(AssetManager assetManager, Node n,
                                                Vector3f pos, Integer size, ColorRGBA color)
    {
